function main=main()
% command line:
%      'KaDE' '--count' 'Occurrences' 'ode.4.12.2.red.ka' '--output''ode.4.12.2.red' '--output-plot''../data/ode.4.12.2.red.data'
...
fprintf(fid,'# KaDE --count Occurrences ode.4.12.2.red.ka --output ode.4.12.2.red --output-plot ../data/ode.4.12.2.red.data\n')
fprintf(fid,'#')
fprintf(fid,' [T]')
fprintf(fid,' A')
fprintf(fid,' |A.x-x|')
