function main=main()
% command line: 
%      'KaDE' '-l' '6' '--count' 'Occurrences' 'ode.4.12.2.red.ka' '--output''ode.4.12.2.red' '--output-plot''../data/ode.4.12.2.red.data'
...
filename = '../data/ode.4.12.2.red.data';
fid = fopen (filename,'w');
fprintf(fid,'# KaDE -l 6 --count Occurrences ode.4.12.2.red.ka --output ode.4.12.2.red --output-plot ../data/ode.4.12.2.red.data\n')
fprintf(fid,'# ')
fprintf(fid,'[T],')
fprintf(fid,'A,')
fprintf(fid,'|A.x-x|,')
