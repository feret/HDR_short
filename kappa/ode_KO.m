function main=main()
% command line: 
%      'KaDE' '-l' '6' '--count' 'Occurrences' 'ode_KO.ka' '--output' 'ode_KO''--output-plot''../data/ode_KO.data'
...
init(5)=t;
var(7)=init(2)+init(3)+init(4); % dimer
init(1)=6; % A(x[.],y[.])
var(6)=init(1); % mono
var(5)=init(1)+init(2)+init(3)+init(4); % total
var(4)=init(4); % A.x-y
var(3)=init(3); % A.y-y
var(2)=init(2); % A.x-x
var(1)=init(1); % A
...
k(2)=1; % A(x[1],y[.]), A(x[1],y[.]) -> A(x[.],y[.]), A(x[.],y[.])
k(3)=1; % A(x[.],y[.]), A(x[.],y[.]) -> A(x[.],y[1]), A(x[.],y[1])
k(4)=1; % A(x[.],y[1]), A(x[.],y[1]) -> A(x[.],y[.]), A(x[.],y[.])
k(5)=1; % A(x[.],y[.]), A(x[.],y[.]) -> A(x[1],y[.]), A(x[.],y[1])
...
filename = '../data/ode_KO.data';
fid = fopen (filename,'w');
fprintf(fid,'# KaDE -l 6 --count Occurrences ode_KO.ka --output ode_KO --output-plot ../data/ode_KO.data\n')
fprintf(fid,'# ')
fprintf(fid,'[T],')
fprintf(fid,'A,')
fprintf(fid,'|A.x-x|,')
...
var(7)=y(2)+y(3)+y(4); % dimer
var(6)=y(1); % mono
var(5)=y(1)+y(2)+y(3)+y(4); % total
var(4)=y(4); % A.x-y
var(3)=y(3); % A.y-y
var(2)=y(2); % A.x-x
var(1)=y(1); % A
