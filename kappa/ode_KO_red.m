function main=main()
% command line:
%      'KaDE' '--count' 'Occurrences' 'ode_KO_red.ka' '--output' 'ode_KO_red''--output-plot''../gnuplot/ode_KO_red.data'
...
filename = '../gnuplot/ode_KO_red.data';
fid = fopen (filename,'w');
fprintf(fid,'# KaDE --count Occurrences ode_KO_red.ka --output ode_KO_red --output-plot ../gnuplot/ode_KO_red.data\n')
fprintf(fid,'# ')
fprintf(fid,'[T] ')
fprintf(fid,'A ')
fprintf(fid,'|A.x-x| ')
