function main=main()
% command line: 
%      'KaDE' '-l' '6' '--count' 'Occurrences' 'ode_KO_red.ka' '--output''ode_KO_red' '--output-plot''../data/ode_KO_red.data'
...
filename = '../data/ode_KO_red.data';
fid = fopen (filename,'w');
fprintf(fid,'# KaDE -l 6 --count Occurrences ode_KO_red.ka --output ode_KO_red --output-plot ../data/ode_KO_red.data\n')
fprintf(fid,'# ')
fprintf(fid,'[T],')
fprintf(fid,'A,')
fprintf(fid,'|A.x-x|,')
