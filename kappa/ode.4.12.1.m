function main=main()
% command line: 
%      'KaDE' '-l' '6' '--count' 'Occurrences' 'ode.4.12.1.ka' '--output''ode.4.12.1' '--output-plot''../data/ode.4.12.1.data'
...
filename = '../data/ode.4.12.1.data';
fid = fopen (filename,'w');
fprintf(fid,'# KaDE -l 6 --count Occurrences ode.4.12.1.ka --output ode.4.12.1 --output-plot ../data/ode.4.12.1.data\n')
fprintf(fid,'# ')
fprintf(fid,'[T],')
fprintf(fid,'mono,')
fprintf(fid,'dimer,')
