...
Dans cet exemple particulier, il est possible d'ignorer la corrélation entre l'état des deux sites des occurrences de la protéine \agent{B}{} également dans la sémantique stochastique. Pour cela, chaque état est abstrait en un triplet $\Astate{}{}{}$, dont la première composante, $\A{n}$, représente le nombre d'occurrences de la protéine \agent{A}{} isolée, le seconde composante, , représente le nombre des occurrences de la protéine \agent{B}{} qui ne sont pas liées à une occurrence de la protéine \agent{A}{}, et la troisième composante, , le nombre d'occurrences de la protéine \agent{B}{} qui sont liées à une occurrence de la protéine \agent{A}{}.
