...
\begin{figure*}[t]%
\hfill\subfigure[Règles de liaison/dissociation entre les sites \sitefont{x} de deux occurrences de la protéine \agentfont{A} dont le site \sitefont{y} est libre.]%
...
\hfill\subfigure[Règles de liaison/dissociation entre les sites \sitefont{y} de deux occurrences de la protéine \agentfont{A} dont le site \sitefont{x} est libre.]%
...
Les règles de liaison et de dissociation entre les occurrences de la protéine \agent{A}{} sont décrites en Fig.~\ref{fig:threerules}.
...
Puisqu'il n'y a plus de distinctions entre les sites de liaison de chaque occurence de la protéine \agent{A}{}, les trois règles de liaison peuvent se résumer en une seule, ainsi que les règles de dissociation.
...
Les deux règles du modèle simplifié sont données en Fig.~\ref{Arule}. La constante de réaction pour la règle de liaison est notée $\K$, alors que celle pour la règle de dissociation $\KD$ (dans le modèle simplifié).
...
\hfill\subfigure[Transposition des sites dans complexes biochimiques formées d'une seule instance de la protéine \agentfont{A}.]%
{\label{fig:trans:mono}%
\begin{minipage}{\linewidth}\hfill\sympatternm{}{Free_Free}\hfill\mbox{}\end{minipage}}%
\hfill\mbox{}

\hfill\subfigure[Transposition des sites de l'occurrence gauche de la protéine \agentfont{A} dans les complexes biochimiques formées de deux instances de la protéine \agentfont{A}.]%
{\label{fig:trans:dimg}%
\sympatternl{sdimer}{x_x_Free_Free}%
\hspace*{2cm}\sympatternl{sdimer}{x_y_Free_Free}}%
\hfill\mbox{}

\hfill\subfigure[Transposition des sites de l'occurrence droite de la protéine \agentfont{A} dans les complexes biochimiques formées de deux instances de la protéine \agentfont{A}.]%
{\label{fig:trans:dimd}%
\sympatternr{sdimer}{x_x_Free_Free}%
\hspace*{2cm}\sympatternr{sdimer}{x_y_Free_Free}}%
\hfill\mbox{}

\hfill\subfigure[Transposition des sites des deux occurrences de la protéine \agentfont{A} dans les complexes biochimiques formées de deux instances de la protéine \agentfont{A}.]{%
\label{fig:trans:dimboth}%
\sympatternd{sdimer}{x_x_Free_Free}%
\hspace*{2cm}\sympatternd{sdimer}{x_y_Free_Free}}%
\hfill\mbox{}

\caption{Effet des transpositions de site sur les complexes biochimiques du modèle jouet.}
...
\subfigure[Transposition des sites de l'occurrence gauche de la protéine \agentfont{A} dans les complexes biochimiques formées de deux instances de la protéine \agentfont{A} partiellement définies.]%
...
\subfigure[Transposition des sites de l'occurrence droite de la protéine \agentfont{A} dans les complexes biochimiques formées de deux instances de la protéine \agentfont{A} partiellement définies.]%
...
\subfigure[Transposition des sites des deux occurrences de la protéine \agentfont{A} dans les complexes biochimiques formées de deux instances de la protéine \agentfont{A} partiellement définies.]%
...
\caption{Effet des transpositions de sites dans les motifs connexes qui ne sont pas des complexes biochimiques.}
