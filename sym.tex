...
\begin{example}
En Fig.~\ref{fig:sym:motig} sont montrés des exemples de transpositions de sites dans des motifs.


\end{example}

\subsubsection{Restriction d'une transposition de deux sites au domaine d'un plongement}

\subsubsection{Effet d'une transposition de sites sur une règle}

\subsubsection{Effet d'une transposition de sites sur une réaction induite par une règle}
